...
<h3 class="text-center"> Liste Etudiants Étangère </h3>

<div class="container">
<form action="/inscriptionexterne" method="POST">
        {{ csrf_field() }}
  ...
  <table class="table table-striped uk-table">
        <thead>
          ...
          <th class="table-active">Cin</th>
            ...
            <th class="table-active">Domaines </th>
        ...
        <tr>
                    @foreach ($ex as $e)
                <td class="table-primary">{{$e->cin}}</td>
                <td class="table-primary">{{$e->user->prenom}}</td>
                <td class="table-primary">{{$e->user->nom}}</td>
                <td class="table-primary">{{$e->date_naissance}}</td>
                <td class="table-primary">{{$e->telephone}}</td>
                <td class="table-primary">{{$e->pays}}</td>
                <td class="table-primary">{{$e->user->ville}}</td>
                <td class="table-primary">{{$e->user->adresse}}</td>
                <td class="table-primary">{{$e->user->email}}</td>
                <td class="table-primary">{{$e->etablissement}}</td>
                <td class="table-primary">{{$e->note_premierbac}}</td>
                <td class="table-primary">{{$e->note_examreg}}</td>
                <td class="table-primary">{{$e->type_bourse}}</td>
                <td class="table-primary">{{$e->universite->nom_universite}}</td>
                <td class="table-primary">{{$e->domaine->nom_domaine}}</td>
                <td class="table-primary">{{$e->filiere->nom_filiere}}</td>
                <td class="table-primary">{{$e->annee_inscription}}</td>
                <td class="table-primary">{{$e->situation_pere}}</td>
                <td class="table-primary">{{$e->situation_mere}}</td>
                <td class="table-primary">
                    <a href='{{$e->featured_1}}' download="{{$e->featured_1}}">
                        <button class="btn btn-primary"><i class="fa fa-download" aria-hidden="true"></i> Situation.Père </button>
                      </a>
                </td>
                <td class="table-primary">
                    <a href='{{$e->featured_2}}' download="{{$e->featured_2}}">
                        <button class="btn btn-primary"><i class="fa fa-download" aria-hidden="true"></i> Situation.Mère </button>
                      </a>
                </td>
                <td class="table-primary">
                    <a href='{{$e->featured_3}}' download="{{$e->featured_3}}">
                        <button class="btn btn-primary"><i class="fa fa-download" aria-hidden="true"></i> Premier.Bac </button>
                    </a>
                </td>
                <td class="table-primary">
                <a href= "{{$e->featured_4}}" download="{{$e->featured_4}}">
